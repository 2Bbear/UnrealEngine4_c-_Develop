...
UCLASS()
class CODEFACTORY_API AGenericPawn : public APawn
{
	GENERATED_BODY()
...
public:
	...
	//Collision
	UPROPERTY(VisibleAnywhere, Category = "Config")
	class UBoxComponent *pColiistion;
	//Spring
	UPROPERTY(VisibleAnywhere, Category = "Config")
...
private:
	...
	void Jump(); //need to binding PlayerInputComponent->BindAction
	void StopJumping(); //need to binding PlayerInputComponent->BindAction
